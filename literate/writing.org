#+title: Writing — spelling, LaTeX, markdown, pandoc, autoinsert
#+property: header-args:emacs-lisp :tangle ../modules/gtk-writing.el :results silent
...
* Markdown, pandoc, autoinsert, text-mode
#+begin_src emacs-lisp
