...
#+begin_src emacs-lisp :eval yes :tangle yes :results silent
...
: Org mode version 9.5.3 (9.5.3-g8e69ad @ /home/gtk/.emacs.d/straight/build/org/)
...
#+begin_src emacs-lisp
  ...
  (add-to-list 'warning-suppress-types 'with-editor) 
  (add-to-list 'warning-suppress-types '(with-editor)) 
  (add-to-list 'warning-suppress-log-types 'with-editor)
  (add-to-list 'warning-suppress-log-types '(with-editor)) 
  (use-package with-editor
    ...
    (define-key (current-global-map)
      ...
      (bind-key "C-c g" 'magit-file-dispatch))
