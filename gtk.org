...
#+begin_src emacs-lisp :tangle yes
  (use-package snakemake-mode
    ...
    (snakemake-mode . lsp)
    :config
    (add-to-list 'lsp-language-id-configuration '(snakemake-mode . "python") 'append))
#+end_src
...
#+begin_src emacs-lisp :tangle no
  ...
  (use-package copilot
    ...
    :ensure t)
  (setq copilot-node-executable "/home/gtk/.nvm/versions/node/v20.8.0/bin/node")
