...
#+begin_src emacs-lisp :tangle yes
      ...
      ;; (projectile-register-project-type 'r '("package.json")
...
#+begin_src emacs-lisp :tangle yes
  ...
  (defun gtk/org-present-start ()
    (setq-local face-remapping-alist '((default (:height 1.5) variable-pitch)
				       (header-line (:height 6.5) variable-pitch)
				       (org-document-title (:height 3.75) org-document-title)
